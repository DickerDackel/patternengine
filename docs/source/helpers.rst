...
.. danger:: This part of the library is highly experimental and prone to be
   replaced with something completely different.  Also the documentation is
   incomplete.
...
.. attention:: FIXME To be continued...
